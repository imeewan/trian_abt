# -*- coding: utf-8 -*-
"""
Created on Sun Feb  4 20:27:45 2018
...
[docs]    def get_exchange_info(self):
...
[docs]    def get_symbol_info(self, symbol):
...
[docs]    def get_orderbook_tickers(self):
...
[docs]    def get_order_book(self, **params):
...
[docs]    def get_recent_trades(self, **params):
...
[docs]    def get_historical_trades(self, **params):
        """Get older trades.
...
[docs]    def get_aggregate_trades(self, **params):
...
[docs]    def aggregate_trade_iter(self, symbol, start_str=None, last_id=None):
...
[docs]    def get_klines(self, **params):
...
[docs]    def get_historical_klines(self, symbol, interval, start_str, end_str=None):
...
[docs]    def get_ticker(self, **params):
...
[docs]    def get_symbol_ticker(self, **params):
...
[docs]    def get_orderbook_ticker(self, **params):
        """Latest price for a symbol or symbols.
...
[docs]    def create_order(self, **params):
        """Send in a new order
...
[docs]    def order_limit(self, timeInForce=TIME_IN_FORCE_GTC, **params):
...
[docs]    def order_limit_buy(self, timeInForce=TIME_IN_FORCE_GTC, **params):
...
[docs]    def order_limit_sell(self, timeInForce=TIME_IN_FORCE_GTC, **params):
...
[docs]    def order_market(self, **params):
...
[docs]    def order_market_buy(self, **params):
...
[docs]    def order_market_sell(self, **params):
...
[docs]    def create_test_order(self, **params):
...
[docs]    def get_order(self, **params):
...
[docs]    def get_all_orders(self, **params):
...
[docs]    def cancel_order(self, **params):
...
[docs]    def get_open_orders(self, **params):
...
[docs]    def get_account(self, **params):
...
[docs]    def get_asset_balance(self, asset, **params):
...
[docs]    def get_my_trades(self, **params):
...
[docs]    def get_account_status(self, **params):
...
[docs]    def get_deposit_history(self, **params):
...
[docs]    def get_withdraw_history(self, **params):
...
[docs]    def get_deposit_address(self, **params):
...
[docs]    def stream_get_listen_key(self):
...
[docs]    def stream_keepalive(self, listenKey):
...
[docs]    def stream_close(self, listenKey):
